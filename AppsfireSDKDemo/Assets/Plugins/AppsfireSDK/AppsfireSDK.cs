...
public class AppsfireSDK : MonoBehaviour {
	...
	private static extern bool afsdk_connectWithAPIKey(string apikey);
	...
	[DllImport ("__Internal")]
	private static extern void afsdk_setFeatures(AFSDKFeature features);
	 ...
	 */
	public static bool ConnectWithAPIKey(string apikey)
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
			return afsdk_connectWithAPIKey(apikey);
		return false;
	}
	 ...
	 */
	public static void setFeatures(AFSDKFeature features)
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
			afsdk_setFeatures(features);
	}
